                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    <div class="row align-items-center">
                                    <div class="col">
                                        <h3 class="page-title">{{ $pembinaAb->nama_kegiatan }}</h3>
                                    </div>
                                    <div class="col-auto text-end float-end ms-auto download-grp">
                                        <a href="{{ route('export/export-absen-rekap')}}" class="btn btn-outline-primary me-2"><i class="fas fa-download"></i> Download</a>
                                    </div>
                                </div>                               
                                <br>
