...
<head>
    ...
    <title>SATU GenBI Cirebon</title>
...
<!-- Bootstrap JS (pastikan ini ada di bawah jQuery) -->
...
<body>
    <div class="main-wrapper">
        <div class="header">
            <div class="header-left">
                <a href="{{ route('home') }}" class="logo">
                    <img src="{{ URL::to('assets/img/logo-genbi.png') }}" alt="Logo">
                </a>
                <a href="{{ route('home') }}" class="logo logo-small">
                    <img src="{{ URL::to('assets/img/logo-genbi-small.png') }}" alt="Logo" width="30" height="30">
                </a>
            </div>
            ...
            <ul class="nav user-menu">
                ...
                <li class="nav-item dropdown has-arrow new-user-menus">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="{{ route('setting/setting-user')}}"><i class="fas fas-gear"></i> Setting Akun</a>
        ...
        @yield('content')
        <footer class="shadow">
            <p class="text-center">©  {{date('Y')}} IT Team GenBI UNMA</p>
        </footer>
    ...
    <script src="{{ URL::to('assets/js/script.js') }}"></script>
        <script src="https://cdn.tiny.cloud/1/m6ob9ny1oqdsphkbusi9xntrtbn7m7xpblz3a6znr3f6xb51/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
<script>
