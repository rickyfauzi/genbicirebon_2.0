                                ...
                                <table
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="actions">
                                                    <a href="{{ url('sekum/anggota-absen/id_kegiatan='.$list->id_kegiatan.'&&id_komisariat='.$list->id_komisariat) }}" class="btn btn-sm bg-success text-white">
                        ...
                        <div class="card-body">
                            <div class="page-header">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto text-end float-end ms-auto download-grp">
                                        <a href="#" class="btn btn-outline-primary me-2"><i class="fas fa-download"></i></a>
                                        <a href="{{ route('sekum/kegiatan-add') }}" class="btn btn-primary text-white"><i class="fas fa-plus"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="table-responsive">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="actions">
                                                    ...
                                                    <p>&ensp;</p>
                                                    <a href="{{ url('sekum/kegiatan-edit/'.$list->id_kegiatan) }}" class="btn btn-sm bg-warning text-white">
                                                        <i class="feather-edit"></i>
                                                    </a>
                                                    <p>&ensp;</p>
                                                    <a class="btn btn-sm bg-danger kegiatan_delete text-white" data-bs-toggle="modal" data-bs-target="#studentUser">
