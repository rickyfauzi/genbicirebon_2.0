            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card shadow">
                        <div class="card-body">
                            <form action="{{ route('sekum/kegiatan/save') }}" method="POST" enctype="multipart/form-data">
                                @csrf                                
                                <div class="row">
                                    <div class="col-12">
                                        <h5 class="form-title student-info">Tambah Kegiatan</h5>
                                    </div>
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <select class="form-control select  @error('jenis') is-invalid @enderror" name="jenis">
                                                ...
                                                <option value="Utama" {{ old('jenis') == 'Utama' ? "selected" : "Utama"}}>Utama</option>
                                                <option value="Tambahan" {{ old('jenis') == 'Tambahan' ? "selected" : "Tambahan"}}>Tambahan</option>   
                                            </select>
                                            @error('jenis')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
