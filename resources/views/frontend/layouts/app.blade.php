...
<head>
    ...
    <style>
        ...
        /* Responsive Design for Mobile (Improved User Experience) */
        ...
        @media (max-width: 374px) {
            ...
            #chat-messages {
                height: calc(75vh - 77px - 81px);
                padding: 12px;
                max-height: calc(75vh - 158px);
            }
