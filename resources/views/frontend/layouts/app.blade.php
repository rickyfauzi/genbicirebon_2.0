...
<head>
    ...
    <style>
        ...
        .msg-bubble .bullet-point .bullet-text {
            margin-left: 8px;
            flex: 1;
        }

        .msg-bubble .sub-bullet {
            display: flex;
            align-items: flex-start;
        ...
        .msg-bubble .sub-bullet .sub-bullet-text {
            margin-left: 8px;
            flex: 1;
        }

        .msg-bubble .info-item {
            display: flex;
            align-items: flex-start;
            margin: 6px 0 6px 16px;
            line-height: 1.5;
        ...
        .msg-bubble .info-item .info-text {
            margin-left: 8px;
            flex: 1;
        }

        .msg-bubble .link-info {
            margin: 12px 0 8px 0;
            padding: 8px 12px;
            background: #f0f8ff;
            border-radius: 8px;
        ...
        .msg-bubble strong:first-child {
            margin-top: 0;
        }

        /* Emoji spacing improvements */
        .msg-bubble .bullet-point::before {
            content: '';
            min-width: 20px;
        }

        .msg-bubble .sub-bullet::before {
            content: '';
            min-width: 18px;
        }

        .msg-bubble .info-item::before {
            content: '';
            min-width: 24px;
        }
