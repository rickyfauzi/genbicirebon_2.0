...
<head>
    ...
    <!--====== Favicon Icon ======-->
    <link rel="shortcut icon" href="{{ asset('assets2/images/logo.png') }}" type="image/svg" />
                ...
                <div class="bi-about-content-wrapper">
                    <div class="bi-about-content" data-aos="fade-right" data-aos-duration="1000">
                        ...
                        <p>
                            ...
                            berbagi energi untuk negeri melalui berbagai kegiatan yang dilibatkan masyarakat umum secara
                            langsung.
                        </p>
                        <p class="genbi-2">
                            Generasi Baru Indonesia, atau yang sering dikenal dengan nama GenBI ialah sebuah komunitas
                            yang terdiri dari mahasiswa-mahasiswa terpilih yang berasal dari beragam latar disiplin ilmu
                            dan keahlian, yang diyakini akan menjadi energi baru yang mampu memberikan kontribusi bagi
            ...
            <div class="testimonial-container">
                ...
                <div class="testimonial-content" data-aos="fade-right" data-aos-duration="1000">
                    ...
                    <p class="" data-aos="fade-left" data-aos-duration="1000"> "
                        saya selama menjadi anggota GenBI, banyak ilmu baru yang saya dapat, banyak teman baru yang saya
                        kenal, dan bisa bertemu orang hebat. namun GenBI juga banyak mengajarkan tentang mempersiapkan
                    ...
                    <div class="faq" id="accordion">
                        <div class="card">
                            ...
                            <div id="faqCollapse-1" class="collapse" aria-labelledby="faqHeading-1"
                                ...
                                <div class="card-body">
                                    <p>Generasi Baru Indonesia (GenBI) adalah komunitas mahasiswa penerima beasiswa dari
                            ...
                            <div id="faqCollapse-2" class="collapse" aria-labelledby="faqHeading-2"
                                ...
                                <div class="card-body">
                                    <p>GenBI bertujuan untuk meningkatkan kepekaan sosial masyarakat, menumbuhkan
                                        semangat kepemimpinan, serta membimbing generasi muda agar dapat berkontribusi
                        ...
                        <div class="card">
                            ...
                            <div id="faqCollapse-5" class="collapse" aria-labelledby="faqHeading-5"
                                ...
                                <div class="card-body">
                                    <p>
                                        Saat ini, GenBI Cirebon memiliki sekitar 300 anggota yang terorganisir dalam 6
                                        komisariat atau cabang di beberapa universitas di Cirebon dan sekitarnya.</p>
                                </div>
                            </div>
                        </div>
                        <div class="card">
        ...
        <div class="container position-relative">
            <div class="row justify-content-center">
                <div class="col-lg-8" data-aos="fade-up" data-aos-duration="1000">
                    ...
                    <p class="lead mb-4">Kepemimpinan Berwawasan, Agen Perubahan, dan Garda Terdepan untuk Masa Depan"
                    </p>
            ...
            <div class="youtube-section">
                <div class="youtube-content">
                    <div class="youtube-info">
                        ...
                        <p class="youtube-description">Dokumentasi kegiatan – kegiatan GenBI Cirebon dalam bentuk video
